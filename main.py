...
if len(graph_input) > 0:
    grapher.make_boxplots(graph_input, sample_list, input_params.output_dirs)
    grapher.make_droplet_count_histogram(graph_input, sample_list, input_params.output_dirs)
